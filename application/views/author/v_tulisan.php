...
<head>
  ...
  <title><?=$sekolah->nama_sekolah?> | List Berita</title>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" href="<?php echo base_url().'author/dashboard/add_tulisan'?>"><span class="fa fa-plus"></span> Post Tulisan</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-striped" style="font-size:13px;">
                ...
                <tbody>
          				<?php
          					$no=0;
          					foreach ($tulisan->result_array() as $i) :
          					   $no++;
                ...
                <tr>
                  ...
                  <td style="text-align:right;">
                        <a class="btn" href="<?php echo base_url().'author/dashboard/get_edit/'.$tulisan_id;?>"><span class="fa fa-pencil"></span></a>
...
<!-- ./wrapper -->
	...
	<?php foreach ($tulisan->result_array() as $i) :
              $tulisan_id=$i['tulisan_id'];
              $tulisan_judul=$i['tulisan_judul'];
              $tulisan_gambar=$i['tulisan_gambar'];
            ?>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $tulisan_id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'author/dashboard/hapus_tulisan'?>" method="post" enctype="multipart/form-data">
