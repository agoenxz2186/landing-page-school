<ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url().'admin/landing'?>"><i class="fa fa-home"></i> Home</a></li>
            <li><a href="<?php echo base_url().'admin/landing/about'?>"><i class="fa fa-code"></i> About</a></li>
          </ul>
        </li>
        <li class="treeview ">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li class=""><a href="<?php echo base_url().'admin/tulisan'?>"><i class="fa fa-list"></i> List Berita</a></li>
