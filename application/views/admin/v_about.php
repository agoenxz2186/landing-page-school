            ...
            <div class="content-wrapper">
                                            ...
                                            <?php foreach ($content as $cont) : ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align:right;">
                                                        <a class="btn" href="<?= base_url('admin/landing/edit_content_about/' . $cont->id) ?>"><span class="fa fa-pencil"></span></a>
                                                        ...
                                                        <div class="modal fade" id="ModalHapus<?= $cont->id ?>" tabindex="-1" role="dialog" aria-labelledby="ModalHapusLabel<?= $cont->id ?>">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form class="form-horizontal" action="<?= base_url() . 'admin/landing/hapus_content_about/' . $cont->id ?>" method="post" enctype="multipart/form-data">
                ...
                <section class="content">
                    ...
                    <div class="box box-default">
                        ...
                        <form action="<?php echo base_url() . 'admin/landing/tambah_content_about' ?>" method="post">
