...
<head>
  ...
  <title><?= $sekolah->nama_sekolah ?> | Data Guru</title>
...
<body class="hold-transition skin-blue sidebar-mini">
                        ...
                        ?>
                          <tr>
                            ...
                            <td style="text-align:right;">
                              <a class="btguru-toggle="modal" data-target="#ModalEdit<?php echo $id; ?>"><span class="fa fa-pencil"></span></a>
  ...
  <!--Modal Edit Album-->
  <?php foreach ($guru->result_array() as $i) :
    $id = $i['guru_id'];
    $nip = $i['guru_nip'];
    $nama = $i['guru_nama'];
    $jenkel = $i['guru_jenkel'];
